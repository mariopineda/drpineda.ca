...
<p>Use the following timeline to help yu stay on track. Note that on most days only half the class time will be used for this assignment. 
<table  border="1" style="width:75%">
  <tr>
    <td>Day 1:</td> 
  ...
  <tr>
    <td>Day 2:</td>
    <td>Online research; identify key features; draft blue prints sketches</td>
  </tr>
  <tr>
    <td>Day 3:</td>
  ...
  <tr>
    <td>Day 9:</td>
	<td>Final report is due (no work on project during classtime)</td>
  </tr>
</table>
