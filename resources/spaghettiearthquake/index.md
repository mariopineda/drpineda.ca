...
<h2>Assigning Individual Roles</h2>
...
<p>Once you have researched about building safe structures it is time to draw up your blue print for the sky scraper. Each teamwill create a architectural drawink (blueprint) using 11 by 16 inch paper. Your blueprints have to be meticulously drawn (using a straight edge/ruler), to scale (the scale must be indicated), all measurements must be included, all details have to labelled and explained. The drawing must be easy to understand yet highly detailed. The final structure must closely match your blueprints or you may fail the building inspection. </p>

<h2>Building permit application</h2>
<p>Once your architectual drawings are complete your team has to apply for a building permit buy submitting the blueprint and a written one page building permit report to the City's Chief Engineer (your teacher). Your building permit report has to list all the features of the building, explain their functions and include a cost estimate using a table that lists all the materials you will need and their cost. Links to relevant internet sites supporting the proposed design has to be included.</p>
...
<h2>Budget</h2>
<p>Your total budget for all materials is $4875. Teams exceeding their project budget will be penalized by a 10% deduction to the overall project grade for every $100 in overdraft. It is the treasurer's responsibility to keep accurate financial records and to always know exactly what your bank balance is. Failure to keep detailed and accurate records will result in fines.</p>
...
<h2>Insurance</h2>
<p>The materials you will be using are delicate and can easily be damaged during construction or while being stored. You have the option of purchasing an insurance policy to protect you from catastrophic accidental losses. The policy will allow you to purchase and additional $1500 of materials. The cost of the policy is $500.</p>

<p>The insurance policy can be purchased from the <em>Smaug & Crickets Insurance Corporation</em> during the first day of the project. The insurance cannot be purchased after the first day.</p>
...
<h2>Construction</h2>
<p>All team members must participate in the construction process. The Project Manager is responsible for storage of the team's structure and materials. Be careful not to waste or unneccessarily damage your materials. Clean up your area at the end of each class or your team may get fined.</p>

<h3>Construction Rules</h3>
1. Spaghetti sticks may not be broken into pieces smaller than 1cm
...
3. Analyze the outcome of the earthquake test. How did your structure perform and why? Did your structure fail or not and why?

<p>The report has to be written using proper English language, grammar, punctuation and spelling. Each question has to be addressed completelly in one or several well-written paragraphs. Each paragraph has to have a clear topic sentence. Proper technical vocabulary is required (see textbook).</p>

<h2>Milestones and Timeline</h2>
<p>Use the following timeline to help yu stay on track. Note that on most days only half the class time will be used for this assignment. Your are expected to work on reports and blueprints on your own time (outside of class) as well.</p> 
<table  border="1" style="width:75%">
  <tr>
    <td>Day 1:</td> 
  ...
  <tr>
    <td>Day 2:</td>
    <td>Online research; finish blue print & building permit report</td>
  </tr>
  <tr>
    <td>Day 3:</td>
    <td>Building permit applications due; start construction and/or revise and re-apply for building permit</td>
  </tr>
  <tr>
    <td>Day 4:</td>
    <td>Construction</td>
  ...
  <tr>
    <td>Day 7:</td>
    <td>Earthquake testing. Your structure must be ready to be tested at the start of the class.</td>
  </tr>
  <tr>
    <td>Day 8:</td>
    <td>Analytical report due (no work on project during classtime)</td>
  </tr>
</table>
...
<p>The following material is avaliable for purchase from <em>The Lizard & Mealworm Supply Company</em> during openiong hours. The opening hours are the first 20 minutes of class time.</p>
<table border="1" style="width:75%">
  <tr>
    <th>Product</th>
    <th>Cost (per item)</th>
...
<table border="1" style="width:40%">
  ...
  <tr>
    <td>Eating of building materials</td> 
	<td>$500</td>
  </tr>
  <tr>
    <td>Disruption or interference with other teams</td>
...
* Too Loud 
* Not participating with team 
* Disturbing or interfering with other teams 

<p>Two incidents will result in disqualification an the individual will be removed from the activity and given a zero on the entire project. </p>
